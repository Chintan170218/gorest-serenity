...
public class UserCRUDTest extends TestBase {
    ...
    public void test006() {
        ...
        Assert.assertEquals("Chaturbhuj Nehru DVM", totalRecord);
    }
    ...
    public void test007() {
        ...
        Assert.assertEquals("dvm_chaturbhuj_nehru@pagac.name", totalRecord);
    }
    ...
    public void test009() {
        ...
        Assert.assertEquals("female", femaleGender);
    }
    ...
    public void test010() {
        ...
        Assert.assertEquals("male", femaleGender);
    }
